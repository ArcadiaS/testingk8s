...
```bash
curl -X DELETE \
    "http://localhost/oauth/tokens/exercitationem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/oauth/clients/mollitia" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/oauth/clients/cum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/oauth/personal-access-tokens/qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
